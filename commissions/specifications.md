...
- [ ] List View
    ...
    - [ ] In this view, there should be a link that will lead to the creation of a commission.

- [ ] Detail View
    - [ ] This view should show the commission information and the list of Jobs needed for the Commission.
    - [ ] A sum of manpower required, and open manpower (difference between sum of manpower and accepted signees) from the jobs should be shown.
